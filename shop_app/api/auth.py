...
from shop_app.dataset.models import UserProfile, RefreshToken
from shop_app.dataset.schema import UserProfileOutSchema, UserProfileInputSchema, UserLoginSchema
...
async def register(user: UserProfileInputSchema, db: Session = Depends(get_db)):
    ...
    if user_db or email_db:
        raise HTTPException(detail='have email or username', status_code=400)
